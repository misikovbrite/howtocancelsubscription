...
$apps = [
  ...
  ["Planet Fitness", "planet-fitness", "💪", "Health & Fitness",  74000, "Cancel Planet Fitness membership"],
  ["LinkedIn",       "linkedin",       "💼", "Productivity",      9900, "Cancel LinkedIn Premium"],
  ["PlayStation+",   "playstation-plus","🎮","Gaming",            8100, "Cancel PlayStation Plus"],
  ["Xbox Game Pass", "xbox-game-pass", "🟢", "Gaming",            6600, "Cancel Xbox Game Pass"],
  ["Twitch",         "twitch",         "🟣", "Streaming",         2400, "Cancel Twitch subscription"],
  ["Apple Music",    "apple-music",    "🎵", "Streaming",         2400, "Cancel Apple Music"],
  ["Instacart+",     "instacart",      "🛒", "Other",             2400, "Cancel Instacart+"],
  ["Zoom",           "zoom",           "📹", "Productivity",      1600, "Cancel Zoom subscription"],
  ["Dropbox",        "dropbox",        "📦", "Productivity",      1300, "Cancel Dropbox subscription"],
  ["Ancestry",       "ancestry",       "🌳", "Other",             1300, "Cancel Ancestry subscription"],
  ["Chegg",          "chegg",          "📚", "Other",             1300, "Cancel Chegg subscription"],
  ["Pandora",        "pandora",        "🎶", "Streaming",         1300, "Cancel Pandora subscription"],
  ["Philo",          "philo",          "📺", "Streaming",         1000, "Cancel Philo subscription"],
  ["NordVPN",        "nordvpn",        "🔒", "Security",          1000, "Cancel NordVPN"],
  ["Hinge",          "hinge",          "❤️", "Social & Dating",   720,  "Cancel Hinge subscription"],
  ["NBA League Pass","nba-league-pass","🏀", "Sports",            720,  "Cancel NBA League Pass"],
  ["YouTube Premium","youtube-premium","▶️", "Streaming",         480,  "Cancel YouTube Premium"],
  ["eHarmony",       "eharmony",       "💑", "Social & Dating",   390,  "Cancel eHarmony"],
  ["MLB.TV",         "mlb-tv",         "⚾", "Sports",            390,  "Cancel MLB.TV"],
  ["MasterClass",    "masterclass",    "🎓", "Other",             390,  "Cancel MasterClass"],
  ["Surfshark",      "surfshark",      "🦈", "Security",          320,  "Cancel Surfshark"],
  ["Match",          "match",          "💘", "Social & Dating",   320,  "Cancel Match subscription"],
  ["MUBI",           "mubi",           "🎞️", "Streaming",         320,  "Cancel MUBI subscription"],
  ["Aura",           "aura",           "🛡️", "Security",          260,  "Cancel Aura subscription"],
  ["Plenty of Fish", "plenty-of-fish", "🐟", "Social & Dating",   260,  "Cancel Plenty of Fish"],
  ["BritBox",        "britbox",        "🇬🇧", "Streaming",        210,  "Cancel BritBox subscription"],
  ["Noom",           "noom",           "⚖️", "Health & Fitness",  170,  "Cancel Noom subscription"],
  ["Peloton",        "peloton",        "🚴", "Health & Fitness",  140,  "Cancel Peloton subscription"],
  ["Google One",     "google-one",     "☁️", "Productivity",      3600, "Cancel Google One subscription"],
  ["Rocket Money",   "rocket-money",   "🚀", "Other",             1000, "Cancel Rocket Money Premium"],
  ["Coursera Plus",  "coursera",       "🎓", "Other",             880,  "Cancel Coursera Plus"],
  ["Wix",            "wix",            "🌐", "Productivity",      590,  "Cancel Wix Premium"],
  ["Squarespace",    "squarespace",    "🔲", "Productivity",      480,  "Cancel Squarespace"],
  ["Scribd",         "scribd",         "📖", "Streaming",         480,  "Cancel Scribd subscription"],
  ["Apple Arcade",   "apple-arcade",   "🕹️", "Gaming",            320,  "Cancel Apple Arcade"],
  ["Mailchimp",      "mailchimp",      "🐒", "Productivity",      320,  "Cancel Mailchimp"],
  ["Babbel",         "babbel",         "🗣️", "Other",             260,  "Cancel Babbel subscription"],
  ["DIRECTV",        "directv",        "📡", "Streaming",         260,  "Cancel DIRECTV subscription"],
  ["Home Chef",      "home-chef",      "🍽️", "Other",             260,  "Cancel Home Chef"],
  ["Discord Nitro",  "discord-nitro",  "💬", "Gaming",            210,  "Cancel Discord Nitro"],
  ["Minecraft",      "minecraft",      "⛏️", "Gaming",            210,  "Cancel Minecraft Realms"],
  ["Discovery+",     "discovery-plus", "🔭", "Streaming",         210,  "Cancel Discovery Plus"],
  ["Funimation",     "funimation",     "⛩️", "Streaming",         170,  "Cancel Funimation"],
  ["EA Play",        "ea-play",        "🎮", "Gaming",            170,  "Cancel EA Play"],
  ["Shudder",        "shudder",        "👻", "Streaming",         170,  "Cancel Shudder subscription"],
  ["Roblox Premium", "roblox-premium", "🧱", "Gaming",            170,  "Cancel Roblox Premium"],
  ["ExpressVPN",     "expressvpn",     "🔐", "Security",          140,  "Cancel ExpressVPN"],
  ["Factor Meals",   "factor-meal",    "🥡", "Other",             140,  "Cancel Factor Meals"],
  ["EveryPlate",     "everyplate",     "🍳", "Other",             140,  "Cancel EveryPlate"],
  ["iCloud+",        "apple-icloud",   "☁️", "Productivity",      110,  "Cancel iCloud+ storage"],
  ["Pimsleur",       "pimsleur",       "🎧", "Other",             110,  "Cancel Pimsleur"],
  ["Blue Apron",     "blue-apron",     "👨‍🍳", "Other",             90,   "Cancel Blue Apron"],
  ["YNAB",           "ynab",           "💵", "Other",             90,   "Cancel YNAB subscription"],
  ["Costco",         "costco",         "🏪", "Other",             3600, "Cancel Costco membership"],
  ["AAA",            "aaa",            "🚗", "Other",             2400, "Cancel AAA membership"],
  ["Adobe Acrobat",  "adobe-acrobat",  "📄", "Productivity",      1000, "Cancel Adobe Acrobat"],
  ["Google Workspace","google-workspace","🏢","Productivity",      880,  "Cancel Google Workspace"],
  ["Lightroom",      "lightroom",      "📷", "Productivity",      880,  "Cancel Adobe Lightroom"],
  ["Strava",         "strava",         "🏃", "Health & Fitness",  390,  "Cancel Strava subscription"],
  ["Figma",          "figma",          "🎨", "Productivity",      320,  "Cancel Figma subscription"],
  ["WHOOP",          "whoop",          "⌚", "Health & Fitness",  320,  "Cancel WHOOP membership"],
  ["Bark",           "bark",           "🐾", "Other",             320,  "Cancel Bark subscription"],
  ["Walmart+",       "walmart-plus",   "🛒", "Other",             260,  "Cancel Walmart Plus"],
  ["Evernote",       "evernote",       "🐘", "Productivity",      260,  "Cancel Evernote"],
  ["MyFitnessPal",   "myfitnesspal",   "🥗", "Health & Fitness",  170,  "Cancel MyFitnessPal Premium"],
  ["Proton VPN",     "proton-vpn",     "🔒", "Security",          170,  "Cancel Proton VPN"],
  ["Adobe Stock",    "adobe-stock",    "🖼️", "Productivity",      170,  "Cancel Adobe Stock"],
  ["AMC+",           "amc-plus",       "🎬", "Streaming",         110,  "Cancel AMC Plus"],
  ["ClickUp",        "clickup",        "✅", "Productivity",      110,  "Cancel ClickUp"],
  ["Notion",         "notion",         "📓", "Productivity",      90,   "Cancel Notion subscription"],
  ["Acorn TV",       "acorn-tv",       "🌰", "Streaming",         70,   "Cancel Acorn TV"],
  ["OnlyFans",       "onlyfans",       "🔞", "Other",           3600, "Cancel OnlyFans subscription"],
  ["Substack",       "substack",       "📰", "Other",           1000, "Cancel Substack subscription"],
  ["Wall Street Journal","wall-street-journal","📈","Other",     720, "Cancel WSJ digital"],
  ["AARP",           "aarp",           "👴", "Other",            720, "Cancel AARP membership"],
  ["Patreon",        "patreon",        "🎨", "Other",            590, "Cancel Patreon subscription"],
  ["BET+",           "bet-plus",       "📺", "Streaming",        590, "Cancel BET+ subscription"],
  ["Pure Flix",      "pureflix",       "✝️", "Streaming",        590, "Cancel Pure Flix"],
  ["Midjourney",     "midjourney",     "🖼️", "Productivity",    390, "Cancel Midjourney subscription"],
  ["QuickBooks",     "quickbooks",     "📊", "Productivity",    390, "Cancel QuickBooks Online"],
  ["Washington Post","washington-post","📰", "Other",            390, "Cancel Washington Post"],
  ["Monday.com",     "monday-com",     "📋", "Productivity",     90, "Cancel Monday.com subscription"],
  ["Apple Fitness+", "apple-fitness-plus","🏃","Health & Fitness",90, "Cancel Apple Fitness Plus"],
  ["Medium",         "medium",         "✍️", "Other",            50,  "Cancel Medium membership"],
  ["Max",            "max",            "🎭", "Streaming",       2400, "Cancel Max (HBO) subscription"],
  ["ViX+",           "vix",            "🌟", "Streaming",        390, "Cancel ViX+ subscription"],
